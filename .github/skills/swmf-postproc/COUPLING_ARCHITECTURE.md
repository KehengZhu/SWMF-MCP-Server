...
## Evidence Order
1. `swmf_get_coupling_info`
2. Component registry lookup if needed to clarify names or scope
3. Direct source reads only when the coupling-info payload leaves a material gap
4. Heuristic source search only for additive context
