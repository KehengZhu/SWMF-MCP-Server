...
swmf_list_idl_tool_capabilities = idl.swmf_list_idl_tool_capabilities
swmf_list_configure_tool_capabilities = configure.swmf_list_configure_tool_capabilities
swmf_list_param_tool_capabilities = param.swmf_list_param_tool_capabilities
swmf_list_build_run_tool_capabilities = build_run.swmf_list_build_run_tool_capabilities
swmf_list_postprocess_tool_capabilities = postprocess.swmf_list_postprocess_tool_capabilities
swmf_list_retrieve_tool_capabilities = retrieve.swmf_list_retrieve_tool_capabilities
