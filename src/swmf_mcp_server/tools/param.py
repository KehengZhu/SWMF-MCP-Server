...
def diagnose_param(
    ...
    if load_error is not None or loaded_text is None:
        payload = {
            ...
            "guided_next_steps": ["Provide valid PARAM input and rerun swmf_diagnose_param."],
            "authority_by_field": {
                "summary": "heuristic",
